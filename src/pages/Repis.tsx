          ...
          <div className="container max-w-4xl">
            <div className="grid gap-12 md:grid-cols-5">
              <div className="md:col-span-3">
                <h2 className="font-display text-2xl font-bold text-foreground">O que é o REPIS?</h2>
                ...
                <h3 className="mt-8 font-display text-xl font-bold text-foreground">Como Funciona?</h3>
              ...
              >
                <div className="rounded-xl border border-border bg-card p-6 shadow-card">
                  <h3 className="font-display text-lg font-bold text-card-foreground">Ações Rápidas</h3>
